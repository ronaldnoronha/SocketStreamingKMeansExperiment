...
listOfExperiments.append({'numNodes':6, 'numPorts':6, 'time':300000, 'executorMem': '8g', 'batchDuration': 1})
listOfExperiments.append({'numNodes':6, 'numPorts':6, 'time':300000, 'executorMem': '12g', 'batchDuration': 1})
listOfExperiments.append({'numNodes':6, 'numPorts':6, 'time':300000, 'executorMem': '14g', 'batchDuration': 1})
# listOfExperiments.append({'numNodes':6, 'numPorts':6, 'time':300000, 'executorMem': '2g', 'batchDuration': 30})
# listOfExperiments.append({'numNodes':6, 'numPorts':6, 'time':300000, 'executorMem': '2g', 'batchDuration': 60})
